...
public:
    ...
    virtual double Evaluate(const FuncArgs& args) const = 0;
...
public:
    ...
    double Evaluate(const FuncArgs& args) const override {
        double result = 0.0;
        switch (type_) {
        case Add:
...
double FormulaAST::Execute(const FuncArgs& args) const {
